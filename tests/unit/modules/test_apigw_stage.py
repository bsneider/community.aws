...
from plugins.modules import apigw_stage
from plugins.modules.apigw_stage import ApiGwStage
...
class TestApiGwStage(unittest.TestCase):
    ...
    def test_process_request_calls_exit_json_when_delete_succeeds(self):
        ...
        self.stage.module.exit_json.assert_called_once_with(
            changed=True, stage=None)
    ...
    def test_process_request_calls_delete_stage_when_state_is_absent(self):
        ...
        self.stage.client.delete_stage.assert_called_once_with(
    ...
    def test_process_request_calls_fail_json_when_delete_fails(self):
        ...
        self.stage.client.delete_stage = mock.MagicMock(
    ...
    def test_process_request_calls_get_stage_when_called(self):
        ...
        self.stage.client.get_stage = mock.MagicMock(
            return_value={'Schaden': 'freude'})

        self.stage.process_request()

        self.stage.client.get_stage.assert_called_once_with(
            restApiId='bob', stageName='testme')
    ...
    def test_process_request_calls_update_stage_when_changes_are_needed(self):
        self.stage.module.params = {
            ...
            'method_settings': [
                {'method_name': '/test', 'method_verb': 'GET',
                    'caching_enabled': True},
                {'method_name': '/test', 'method_verb': 'PUT',
                    'caching_enabled': True},
            ]
        }
        ...
        self.stage.client.update_stage.assert_called_once_with(
            restApiId='bob', stageName='testme', patchOperations=mock.ANY)
        self.assertEqual(len(expected_patch_ops), len(
            self.stage.client.update_stage.call_args[1]['patchOperations']))
        self.assertItemsEqual(
            expected_patch_ops, self.stage.client.update_stage.call_args[1]['patchOperations'])
    ...
    def test_process_request_calls_fail_json_when_update_stage_raises_exception(self):
        ...
        self.stage.client.get_stage = mock.MagicMock(return_value=mock_result)
        self.stage.client.update_stage = mock.MagicMock(
            side_effect=BotoCoreError)
    ...
    def test_process_request_calls_get_stage_after_successful_update(self):
        ...
        self.stage.client.get_stage = mock.MagicMock(
            side_effect=[mock_result, 'Hurray! It worked!'])
        ...
        self.stage.client.update_stage.assert_called_once_with(
            restApiId='bob', stageName='testme',
            patchOperations=[{'op': 'replace', 'path': '/cacheClusterSize', 'value': 'something else'}])
        self.stage.client.get_stage.assert_called_with(
            restApiId='bob', stageName='testme')
        self.stage.module.exit_json.assert_called_once_with(
            changed=True, stage='Hurray! It worked!')
    ...
    def test_main(self, mock_ApiGwStage, mock_AnsibleModule):
        ...
        self.assertEqual(
            1, mock_ApiGwStage_instance.process_request.call_count)
