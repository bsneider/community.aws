...
import mock
import plugins.modules.apigw_deployment as apigw_deployment
from plugins.modules.apigw_deployment import ApiGwDeployment
...
class TestApiGwDeployment(unittest.TestCase):
    ...
    def test_process_request_creates_deployment_and_calls_exit_json(self):
        ...
        self.deployment.module.exit_json.assert_called_once_with(
            changed=True, deployment='I am called')
    ...
    def test_process_request_nominally_supports_check_mode_so_other_tasks_do_not_break(self):
        ...
        self.assertEqual(
            0, self.deployment.client.create_deployment.call_count)
        self.deployment.module.exit_json.assert_called_once_with(
            changed=True, deployment=None)
    ...
    def test_main(self, mock_ApiGwDeployment, mock_AnsibleModule):
        ...
        mock_ApiGwDeployment.assert_called_once_with(
            mock_AnsibleModule_instance)
        self.assertEqual(
            1, mock_ApiGwDeployment_instance.process_request.call_count)
