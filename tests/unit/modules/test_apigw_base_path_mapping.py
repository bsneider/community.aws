...
from plugins.modules import apigw_base_path_mapping
from plugins.modules.apigw_base_path_mapping import ApiGwBasePathMapping
...
class TestApiGwBasePathMapping(unittest.TestCase):
    ...
    def test_process_request_calls_get_base_path_mappings_and_stores_result_when_invoked(self, m):
        resp = {
            'items': [
                {'basePath': 'not a match',
                    'restApiId': 'rest_api_id', 'stage': 'whatever'},
                {'basePath': 'test_base_path',
                    'restApiId': 'rest_api_id', 'stage': 'yes'},
            ],
        }
        self.bpm.client.get_base_path_mappings = mock.MagicMock(
            return_value=resp)

        self.bpm.process_request()

        self.assertEqual(resp['items'][1], self.bpm.me)
        self.bpm.client.get_base_path_mappings.assert_called_once_with(
            domainName='testify')
    ...
    def test_process_request_calls_exit_json_with_expected_value_after_successful_delete(self, mr, md):
        ...
        self.bpm.module.exit_json.assert_called_once_with(
            changed='Mitchell!', base_path_mapping=None)
    ...
    def test_process_request_calls_delete_base_path_mapping_when_state_absent_and_base_path_mapping_found(self, m):
        ...
        self.bpm.client.delete_base_path_mapping.assert_called_once_with(
            domainName='testify', basePath='test_base_path')
    ...
    def test_process_request_skips_delete_and_calls_exit_json_with_true_when_check_mode_set_and_auth_found(self, m):
        ...
        self.assertEqual(
            0, self.bpm.client.delete_base_path_mapping.call_count)
        self.bpm.module.exit_json.assert_called_once_with(
            changed=True, base_path_mapping=None)
    ...
    def test_process_request_calls_fail_json_when_delete_base_path_mapping_raises_error(self, m):
        ...
        self.bpm.client.delete_base_path_mapping = mock.MagicMock(
            side_effect=BotoCoreError)
        self.bpm.process_request()
    ...
    def test_process_request_calls_exit_json_with_expected_value_after_successful_create(self, mra, mca):
        ...
        self.bpm.module.exit_json.assert_called_once_with(
            changed='heart', base_path_mapping='pumping')

    @patch.object(ApiGwBasePathMapping, '_retrieve_base_path_mapping', return_value=None)
    def test_process_request_returns_create_base_path_mapping_result_when_create_succeeds(self, m):
        self.bpm.client.create_base_path_mapping = mock.MagicMock(
            return_value='woot')
        self.bpm.process_request()

        self.bpm.module.exit_json.assert_called_once_with(
            changed=True, base_path_mapping='woot')
    ...
    def test_process_request_skips_create_call_and_returns_changed_True_when_check_mode(self, m):
        ...
        self.assertEqual(
            0, self.bpm.client.create_base_path_mapping.call_count)
        self.bpm.module.exit_json.assert_called_once_with(
            changed=True, base_path_mapping=None)
    ...
    @patch('plugins.modules.apigw_base_path_mapping.ApiGwBasePathMapping._create_patches', return_value=[])
    ...
    def test_process_request_skips_update_base_path_mapping_and_replies_false_when_no_changes(self, m, mcp):
        ...
        self.assertEqual(
            0, self.bpm.client.update_base_path_mapping.call_count)
        self.bpm.module.exit_json.assert_called_once_with(
            changed=False, base_path_mapping={'something': 'here'})

    @patch('plugins.modules.apigw_base_path_mapping.ApiGwBasePathMapping._create_patches', return_value=['patches!'])
    ...
    def test_process_request_calls_fail_json_when_update_base_path_mapping_raises_exception(self, m, mcp):
        self.bpm.client.update_base_path_mapping = mock.MagicMock(
            side_effect=BotoCoreError())
        self.bpm.process_request()
    ...
    def test_process_request_returns_result_of_find_when_update_is_successful(self, m, mcp):
        ...
        self.bpm.module.exit_json.assert_called_once_with(
            changed=True, base_path_mapping='second call')
    ...
    def test_process_request_skips_update_base_path_mapping_and_replies_true_when_check_mode(self, m, mcp):
        ...
        self.assertEqual(
            0, self.bpm.client.update_base_path_mapping.call_count)
        self.bpm.module.exit_json.assert_called_once_with(
            changed=True, base_path_mapping={'something': 'here'})
    ...
    def test_main(self, mock_ApiGwBasePathMapping, mock_AnsibleModule):
        ...
        mock_ApiGwBasePathMapping.assert_called_once_with(
